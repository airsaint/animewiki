...
function useCreateMotionContext(props) {
  const { initial, animate: animate3 } = getCurrentTreeVariants(props, (0, import_react15.useContext)(MotionContext));
  return (0, import_react15.useMemo)(() => ({ initial, animate: animate3 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate3)]);
}
...
function buildHTMLStyles(state, latestValues, options, transformTemplate) {
  const { style: style2, vars, transform: transform3, transformOrigin: transformOrigin2 } = state;
...
function addHoverEvent(node2, isActive) {
  ...
  const handleEvent = (event, info) => {
    ...
    if (node2.animationState && props.whileHover) {
      node2.animationState.setActive(AnimationType.Hover, isActive);
    }
...
var AnimationFeature = class extends Feature {
  ...
  updateAnimationControlsSubscription() {
    const { animate: animate3 } = this.node.getProps();
    this.unmount();
    if (isAnimationControls(animate3)) {
      this.unmount = animate3.subscribe(this.node);
    }
  }
  /**
...
function removeBoxTransforms(box, transforms3, originBox, sourceBox) {
  removeAxisTransforms(box.x, transforms3, xKeys2, originBox ? originBox.x : void 0, sourceBox ? sourceBox.x : void 0);
  removeAxisTransforms(box.y, transforms3, yKeys2, originBox ? originBox.y : void 0, sourceBox ? sourceBox.y : void 0);
}
...
function ReorderGroup({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const context = {
    ...
    registerItem: (value, layout3) => {
      if (layout3 && order3.findIndex((entry) => value === entry.value) === -1) {
    ...
    updateOrder: (id4, offset2, velocity) => {
      if (isReordering.current)
        return;
      const newOrder = checkReorder(order3, id4, offset2, velocity);
      if (order3 !== newOrder) {
...
function ReorderItem({ children, style: style2 = {}, value, as = "li", onDrag, layout: layout3 = true, ...props }, externalRef) {
  const Component2 = useConstant(() => motion(as));
  ...
  return React10.createElement(Component2, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style2, x: point.x, y: point.y, zIndex }, layout: layout3, onDrag: (event, gesturePoint) => {
...
function createAnimate(AnimatePolyfill) {
  return function animate3(elements, keyframes3, options = {}) {
...
var animate2 = createAnimate(Animation);
...
function useCounter(props = {}) {
  ...
  const clamp3 = (0, import_react86.useCallback)(
    (value2) => {
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const childrenToRender = (0, import_react122.useMemo)(
    () => shouldWrapChildren ? import_react122.Children.map(children, (child, index2) => (0, import_jsx_runtime72.jsx)(WrapItem, { children: child }, index2)) : children,
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime81.jsx)(import_jsx_runtime81.Fragment, { children: chunks.map((chunk, index2) => {
    return chunk.match ? (0, import_jsx_runtime81.jsx)(Mark, { sx: styles, children: chunk.text }, index2) : (0, import_jsx_runtime81.jsx)(import_react124.Fragment, { children: chunk.text }, index2);
  }) });
}
...
function useSpinner(increment, decrement) {
  ...
  const stop2 = (0, import_react147.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
var SelectIcon = (props) => {
  ...
  return (0, import_jsx_runtime136.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react158.isValidElement)(children) ? clone : null });
};
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react167.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react167.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react167.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react168.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index2) => (0, import_react168.createElement)(
      TabPanelProvider,
      {
        key: index2,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react168.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react168.useState)(false);
  useSafeLayoutEffect(() => {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react169.useMemo)(() => ctx, [ctx]);
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react170.useRef)();
  const clearEnterTimeout = (0, import_react170.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react170.useRef)();
  const clearExitTimeout = (0, import_react170.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react170.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react170.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react170.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
    exitTimeout.current = win.setTimeout(closeNow, closeDelay);
  }, [closeDelay, closeNow, clearEnterTimeout]);
  const onClick = (0, import_react170.useCallback)(() => {
    if (isOpen && closeOnClick) {
      closeWithDelay();
    }
  }, [closeOnClick, closeWithDelay, isOpen]);
  const onPointerDown = (0, import_react170.useCallback)(() => {
  ...
  const getTooltipPositionerProps = (0, import_react170.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react170.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    const child = import_react171.Children.only(children);
    trigger2 = (0, import_react171.cloneElement)(
      child,
